...
date: Aug 29 2022
description: "It always bothers me when people sell some percentages they calculated somehow as statistics, particularly in the media. 
...
image: /images/post_banners/statistics.jpeg
---
...
<table>
  ...
  <tr>
    ...
    <tr>
    <td><b>All Departments</b></td>
    <td>2701</td>
    <td>1204</td>
    <td className={"tableHighlightGreen"}>44.6</td>
    <td>1835</td>
    <td>573</td>
    <td className={"tableHighlightRed"}>31.2</td>
  </tr>
</table>

<div className={"warning box"}>
   ⚠ It seems like women are disavantaged overall!
</div>
...
<table>
  ...
  <tr>
    ...
    <td>825</td>
    <td>528</td>
    <td className={"tableHighlightRed"}>64.0</td>
    <td>108</td>
    <td>89</td>
    <td className={"tableHighlightGreen"}>82.4</td>
  </tr>
  ...
  <tr>
    ...
    <td>560</td>
    <td>353</td>
    <td className={"tableHighlightRed"}>63.0</td>
    <td>25</td>
    <td>17</td>
    <td className={"tableHighlightGreen"}>68.0</td>
  </tr>
  ...
  <tr>
    ...
    <td>325</td>
    <td>110</td>
    <td className={"tableHighlightYellow"}>33.8</td>
    <td>593</td>
    <td>202</td>
    <td className={"tableHighlightYellow"}>34.1</td>
  </tr>
  ...
  <tr>
    ...
    <td>417</td>
    <td>138</td>
    <td className={"tableHighlightRed"}>33.1</td>
    <td>375</td>
    <td>131</td>
    <td className={"tableHighlightGreen"}>34.9</td>
  </tr>
  ...
  <tr>
    ...
    <td>201</td>
    <td>53</td>
    <td className={"tableHighlightRed"}>26.4</td>
    <td>393</td>
    <td>110</td>
    <td className={"tableHighlightGreen"}>28.0</td>
  </tr>
  ...
  <tr>
    ...
    <td>373</td>
    <td>22</td>
    <td className={"tableHighlightRed"}>5.9</td>
    <td>341</td>
    <td>24</td>
    <td className={"tableHighlightGreen"}>7.0</td>
  </tr>

</table>

<div className={"warning box"}>
   ⚠ It seems like men are disavantaged in every single department!
</div>
...
<div className={"info box"}>
   ⓘ The Simpsons paradox shows that a trend that might show up in data that is put into grups, can disappear or even reverse when the groups ar combined. This is critical to understand if you want to interpret data correctly.
</div>
