...
date: Jul 27 2022
image: /images/post_banners/password.webp
description: "I'm taking a look how user-authentifications works.  \n
...
<PlotlyPlot jsonFile="/plots/input_to_output.json" />

But there are still hidden patterns in the outputs as shown here:
<PlotlyPlot jsonFile="/plots/pattern.json" />
