...
date: Jun 6 2022
description: "In this post we look at the fampus mandelbrot set.  \n
...
source: https://github.com/scheuclu/mandelbrot
deployed: https://www.google.com
image: /images/post_banners/mandelbrot.png
---
...
<BlockMath>{'\\forall c \\in \\mathbb{C} \\\\ ~  z_{0}=0 \\\\  z_{i+1}=z_{i}^2+c'}</BlockMath>,
